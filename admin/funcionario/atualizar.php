...
if (isset($_GET['id'])) {
    $id = intval($_GET['id']); // Certifique-se de que é um inteiro
    ...
    if ($Funcionario->CarregarPerfil()) {
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['idFuncionario'])) {
            ...
            // Aqui você deve preencher as variáveis para serem usadas no formulário
    ...
    echo "ID do funcionário não especificado.<br>";
}
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="mb-3">
                            ...
                            <input value="<?php echo $senhaFuncionario; ?>" type="password" class="form-control" id="senhaFuncionario" name="senhaFuncionario" required>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="mb-3">
