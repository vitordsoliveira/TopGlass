            ...
            <tbody>
                <?php foreach ($lista as $linha): ?>
                    <tr>
                        ...
                        <td><a href="index.php?p=orcamento&orc=atualizar&id=<?php echo $linha['idOrcamento']; ?>">Atualizar</a>
                        </td>
                        <td><a href="index.php?p=orcamento&orc=desativar&id=<?php echo $linha['idOrcamento']; ?>">Desativar</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
